...
p+geom_line(size=3)+geom_errorbar(ymax=mean_lum+lum_se,ymin=mean_lum-lum_se,size=3)+ylim(2,8)+ggtitle("intratibial cancer cell injection")+labs(x="Days post surgery",y="Mean luminescence (log)")+theme_classic()
